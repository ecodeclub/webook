...
func (m *MockSyncEventProducer) Produce(ctx context.Context, evt event.QuestionEvent) error {
	m.ctrl.T.Helper()
...
func (c *SyncEventProducerProduceCall) Do(f func(context.Context, event.QuestionEvent) error) *SyncEventProducerProduceCall {
	c.Call = c.Call.Do(f)
	return c
}

// DoAndReturn rewrite *gomock.Call.DoAndReturn
func (c *SyncEventProducerProduceCall) DoAndReturn(f func(context.Context, event.QuestionEvent) error) *SyncEventProducerProduceCall {
