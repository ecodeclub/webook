...
func InitModule(db *gorm.DB, intrModule *interactive.Module, ec ecache.Cache, esClient *elastic.Client, perm *permission.Module, aiModule *ai.Module, memberModule *member.Module, sp session.Provider, q mq.MQ) (*Module, error) {
