...
func (m *MockService) FindOrders(ctx context.Context, offset, limit int) (int64, []domain.Order, error) {
	m.ctrl.T.Helper()
	ret := m.ctrl.Call(m, "FindOrders", ctx, offset, limit)
	ret0, _ := ret[0].(int64)
	ret1, _ := ret[1].([]domain.Order)
	ret2, _ := ret[2].(error)
	return ret0, ret1, ret2
}

// FindOrders indicates an expected call of FindOrders.
func (mr *MockServiceMockRecorder) FindOrders(ctx, offset, limit any) *MockServiceFindOrdersCall {
	mr.mock.ctrl.T.Helper()
	call := mr.mock.ctrl.RecordCallWithMethodType(mr.mock, "FindOrders", reflect.TypeOf((*MockService)(nil).FindOrders), ctx, offset, limit)
	return &MockServiceFindOrdersCall{Call: call}
}

// MockServiceFindOrdersCall wrap *gomock.Call
type MockServiceFindOrdersCall struct {
	*gomock.Call
}

// Return rewrite *gomock.Call.Return
func (c *MockServiceFindOrdersCall) Return(arg0 int64, arg1 []domain.Order, arg2 error) *MockServiceFindOrdersCall {
	c.Call = c.Call.Return(arg0, arg1, arg2)
	return c
}

// Do rewrite *gomock.Call.Do
func (c *MockServiceFindOrdersCall) Do(f func(context.Context, int, int) (int64, []domain.Order, error)) *MockServiceFindOrdersCall {
	c.Call = c.Call.Do(f)
	return c
}

// DoAndReturn rewrite *gomock.Call.DoAndReturn
func (c *MockServiceFindOrdersCall) DoAndReturn(f func(context.Context, int, int) (int64, []domain.Order, error)) *MockServiceFindOrdersCall {
	c.Call = c.Call.DoAndReturn(f)
	return c
}
...
func (mr *MockServiceMockRecorder) FindUserVisibleOrdersByUID(ctx, uid, offset, limit any) *MockServiceFindUserVisibleOrdersByUIDCall {
	mr.mock.ctrl.T.Helper()
...
// Do rewrite *gomock.Call.Do
func (c *MockServiceFindUserVisibleOrdersByUIDCall) Do(f func(context.Context, int64, int, int) ([]domain.Order, int64, error)) *MockServiceFindUserVisibleOrdersByUIDCall {
	c.Call = c.Call.Do(f)
	return c
}

// DoAndReturn rewrite *gomock.Call.DoAndReturn
func (c *MockServiceFindUserVisibleOrdersByUIDCall) DoAndReturn(f func(context.Context, int64, int, int) ([]domain.Order, int64, error)) *MockServiceFindUserVisibleOrdersByUIDCall {
	c.Call = c.Call.DoAndReturn(f)
	return c
}
