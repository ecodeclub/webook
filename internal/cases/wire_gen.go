...
func InitModule(db *egorm.Component, intrModule *interactive.Module, aiModule *ai.Module, esClient *elasticsearch.TypedClient, memberModule *member.Module, sp session.Provider, redisCache ecache.Cache, q mq.MQ) (*Module, error) {
