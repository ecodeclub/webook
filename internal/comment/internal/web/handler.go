...
func (h *Handler) MemberRoutes(server *gin.Engine) {
	...
	group.POST("/list", ginx.BS[CommentListRequest](h.CommentList))
...
func (h *Handler) CommentList(ctx *ginx.Context, req CommentListRequest, _ session.Session) (ginx.Result, error) {
...
func (h *Handler) GetReplies(ctx *ginx.Context, req GetRepliesRequest, _ session.Session) (ginx.Result, error) {
