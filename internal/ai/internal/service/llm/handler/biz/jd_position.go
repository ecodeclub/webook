...
type JDPositionHandlerBuilder struct {
}

func NewJDPositionHandlerBuilder() *JDPositionHandlerBuilder {
	return &JDPositionHandlerBuilder{}
}

func (b *JDPositionHandlerBuilder) Next(next handler.Handler) handler.Handler {
