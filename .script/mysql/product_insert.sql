...
INSERT INTO `product_skus` (sn, product_spu_id, name, description, price, stock, stock_limit, sale_type, attrs, status, ctime, utime)
VALUES
    ('SKU001', 1, '星期会员', '提供一周的会员服务', 799, 1000, 100000000, 1, '{"days":7}', 2, UNIX_TIMESTAMP(), UNIX_TIMESTAMP()),
    ('SKU002', 1, '月会员', '提供一个月的会员服务', 990, 1000, 100000000, 1, '{"days":31}', 2,  UNIX_TIMESTAMP(), UNIX_TIMESTAMP()),
    ('SKU003', 1, '季度会员', '提供一个季度的会员服务', 2970, 1000, 100000000, 1, '{"days":100}', 2, UNIX_TIMESTAMP(), UNIX_TIMESTAMP()),
    ('SKU004', 1, '年会员', '提供一年的会员服务', 11880, 1000, 100000000, 1, '{"days":366}', 2, UNIX_TIMESTAMP(), UNIX_TIMESTAMP()),
    ('SKU005', 2, '用户项目', '中小型面试项目', 9999, 1000, 100000000, 1, '{"lang":"Go"}', 2, UNIX_TIMESTAMP(), UNIX_TIMESTAMP()),
    ('SKU006', 2, '权限项目', '中大型面试项目', 19999, 1000, 100000000, 1, '{"lang":"Go"}', 2, UNIX_TIMESTAMP(), UNIX_TIMESTAMP());