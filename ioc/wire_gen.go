...
func InitApp() (*App, error) {
	...
	component := initGinxServer(provider, checkMembershipMiddlewareBuilder, localActiveLimit, checkPermissionMiddlewareBuilder, v4, v5, v6, v7, v8, v9, v10, v11, v12, v13, v14, v15, v16, v17, v18, v19, v20, v21, v22, v23, v24, v25, v26, v27, v28, v29, v30, v31)
	v32 := projectModule.AdminHdl
	v33 := roadmapModule.AdminHdl
	v34 := baguwenModule.AdminHdl
	v35 := baguwenModule.AdminSetHdl
	v36 := casesModule.AdminHandler
	v37 := casesModule.AdminSetHandler
	v38 := marketingModule.AdminHdl
	v39 := aiModule.AdminHandler
	v40 := reviewModule.AdminHdl
	v41 := casesModule.KnowledgeBaseHandler
	v42 := baguwenModule.KnowledgeBaseHdl
	v43 := materialModule.AdminHdl
	companyModule, err := company.InitModule(v)
	if err != nil {
		return nil, err
	}
	v44 := companyModule.Hdl
	adminServer := InitAdminServer(v32, v33, v34, v35, v36, v37, v38, v39, v40, v41, v42, v43, v44)
	v45 := orderModule.CloseTimeoutOrdersJob
	v46 := creditModule.CloseTimeoutLockedCreditsJob
	v47 := paymentModule.SyncWechatOrderJob
	reconModule, err := recon.InitModule(orderModule, paymentModule, creditModule)
	if err != nil {
		return nil, err
	}
	v48 := reconModule.SyncPaymentAndOrderJob
	v49 := initCronJobs(v45, v46, v47, v48)
	v50 := baguwenModule.KnowledgeJobStarter
	v51 := initJobs(v50)
	app := &App{
		Web:   component,
		Admin: adminServer,
